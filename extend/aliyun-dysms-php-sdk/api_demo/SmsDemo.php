...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = 'LTAIbADMy997Tb1q';// AccessKeyId

        $accessKeySecret = 'vryeRVTsPU4I82zWHcgEU3dpoC0lwz '; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone,$code,$template) {
...
$response = SmsDemo::sendSms('100000','15207251055','SMS_172598253');
