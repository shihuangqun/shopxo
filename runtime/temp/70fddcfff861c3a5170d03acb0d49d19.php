<?php /*a:3:{s:87:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/admin\login_info.html";i:1566181846;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\header.html";i:1566177929;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="account-pages">
	<div class="wrapper-page">
		<div class="text-center">
            <span class="logo fw-70">你的后衣橱商城</span>
        </div>
        <div class="m-t-40 card-box admin-login">
            <div class="panel-body">
            	<form class="am-form form-validation" action="<?php echo MyUrl('admin/admin/login'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/index/index'); ?>">
            		<div class="am-g">
            			<div class="am-form-group am-form-group-refreshing">
					      <input type="text" placeholder="用户名" name="username" pattern="<?php echo lang('common_regex_username'); ?>" data-validation-message="用户名格式 5~18 个字符（可以是字母数字下划线）" class="am-radius" required />
					    </div>
					    <div class="am-form-group am-form-group-refreshing form-horizontal m-t-20">
					      <input type="password" placeholder="登录密码" name="login_pwd" pattern="<?php echo lang('common_regex_pwd'); ?>" data-validation-message="密码格式 6~18 个字符" class="am-radius" required />
					    </div>
                        <div class="am-form-group am-form-group-refreshing">
