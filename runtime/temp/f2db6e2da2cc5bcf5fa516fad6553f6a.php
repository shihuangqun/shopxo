<?php /*a:4:{s:87:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/sms/index.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/header.html";i:1563161086;s:85:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/sms/nav.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="am-alert am-alert-warning am-radius" data-am-alert>
    ...
    <p class="fs-12">阿里云短信管理地址 https://dysms.console.aliyun.com/dysms.htm</p>
		...
		<!-- form start -->
		<form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/sms/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/sms/index', ['type'=>'sms']); ?>">
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_sms_apikey']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_sms_apikey']['describe']); ?></span></label>
				<input type="text" name="<?php echo htmlentities($data['common_sms_apikey']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_sms_apikey']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_sms_apikey']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_sms_apikey']['value']); ?>"<?php endif; ?> />
			</div>
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_sms_apisecret']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_sms_apisecret']['describe']); ?></span></label>
				<input type="text" name="<?php echo htmlentities($data['common_sms_apisecret']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_sms_apisecret']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_sms_apisecret']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_sms_apisecret']['value']); ?>"<?php endif; ?> />
			</div>
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_sms_sign']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_sms_sign']['describe']); ?></span></label>
				<input type="text" name="<?php echo htmlentities($data['common_sms_sign']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_sms_sign']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_sms_sign']['error_tips']); ?>" class="am-radius" maxlength="16" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_sms_sign']['value']); ?>"<?php endif; ?> />
			</div>
