        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				...
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation admin-save" action="<?php echo MyUrl('admin/brandcategory/save'); ?>" method="POST" request-type="ajax-reload" request-value="">
...
<!-- footer end -->
<script>
	Tree(0, "<?php echo MyUrl('admin/brandcategory/getnodeson'); ?>", 0);
</script>