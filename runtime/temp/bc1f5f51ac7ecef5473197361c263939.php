...
<!-- conntent start  -->
<div class="am-g my-content" <?php if(!empty($user_forgetpwd_left_data['bg_color'])): ?>style="background-color:<?php echo htmlentities($user_forgetpwd_left_data['bg_color']); ?>;"<?php endif; ?>>
	<div class="am-container user-forgetpwd-container">
		<div class="am-hide-sm-only am-u-md-6 am-u-lg-8 am-vertical-align am-text-center container-left">
			<?php if(!empty($user_forgetpwd_left_data['images'])): ?>
                <a href="<?php if(empty($user_forgetpwd_left_data['url'])): ?>javascript:;<?php else: ?><?php echo htmlentities($user_forgetpwd_left_data['url']); ?><?php endif; ?>" target="_blank">
                    <img src="<?php echo htmlentities($user_forgetpwd_left_data['images']); ?>" class="am-vertical-align-middle" alt="密码找回" />
                </a>
            <?php endif; ?>
		</div>
		<div class="am-u-sm-12 am-u-md-6 am-u-lg-4 container-right">
			<div class="forgetpwd-top">
				<?php if(MyC('home_user_login_state') == 1): ?>
					<span>已有帐号？</span>
					<a href="<?php echo MyUrl('index/user/logininfo'); ?>" class="am-btn am-btn-secondary am-btn-xs am-radius">立即登录</a>
				<?php endif; ?>
			</div>
			<div class="user-form-container">
				<!-- form start -->
				<form class="am-form form-validation" method="post" action="<?php echo MyUrl('index/user/forgetpwd'); ?>" request-type="ajax-url" request-value="<?php echo MyUrl('index/user/logininfo'); ?>">
					...
					<div class="am-form-group am-form-group-refreshing business-form-block">
						...
						<div class="am-input-group am-input-group-sm">
			                ...
			                <span class="am-input-group-btn">
			                    <button class="am-btn am-btn-default am-radius btn-loading-example verify-submit" type="button" data-am-loading="{spinner:'circle-o-notch', loadingText:'发送中...'}" data-url="<?php echo MyUrl('index/user/forgetpwdverifysend'); ?>" data-verify="<?php echo MyC('home_img_verify_state'); ?>" data-text="获取验证码" data-send-text="还有 {time} 秒" data-time="<?php echo MyC('common_verify_time_interval', 30, true); ?>" data-form-tag="form.form-validation">获取验证码</button>
			                </span>
			            </div>
		            </div>
				...
				<div class="am-modal-dialog am-radius">
					...
					<div class="am-modal-bd">
						<div class="base">
							...
							<div class="am-fl">
								<img src="<?php echo MyUrl('index/user/userverifyentry', ['type'=>'forget']); ?>" class="am-radius c-p" id="verify-img" onClick="this.src=this.src+'#'+Math.random();" />
								<a href="javascript:;" class="verify-tips" onClick="document.getElementById('verify-img').src='<?php echo MyUrl('index/user/userverifyentry', ['type'=>'forget']); ?>#'+Math.random();">看不清换一张</a>
							</div>
						</div>
