<?php /*a:3:{s:89:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/supplier\save_info.html";i:1565147718;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\header.html";i:1566177929;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
    <div class="content">
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/supplier/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/supplier/index'); ?>">
            <legend>
				<span class="fs-16">
            ...
            <div class="am-form-group">
                <label>供应商电话</label>
                <input type="text" placeholder="供应商电话" name="phone" pattern="<?php echo lang('common_regex_username'); ?>" data-validation-message="必须是11位数字" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['phone']); ?>" <?php endif; ?> required />
            </div>
