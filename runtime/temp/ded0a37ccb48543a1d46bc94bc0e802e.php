...
<!-- content -->
<div class="am-container search-content" data-category-id="<?php echo htmlentities($params['category_id']); ?>">
    <div class="search-list">
        <div class="am-u-sm-12 am-u-md-12 am-padding-left-0 am-padding-right-0">
                        ...
                        <dl id="screening-brand-dl">
                            <dt class="am-badge am-round">品牌</dt>   
                             <div class="dd-conent" data-selected-tag="screening-brand">                                        
                                ...
                                <?php if(!empty($brand_list)): foreach($brand_list as $brand): ?>
                                        <dd><a href="javascript:;" data-value="<?php echo htmlentities($brand['id']); ?>" data-field="brand_id"><?php echo htmlentities($brand['name']); ?></a></dd>
                                    <?php endforeach; else: ?>
                        ...
                        <dl>
                            ...
                            <div class="dd-conent" data-selected-tag="screening-category">
                                ...
                                <?php if(!empty($category_list)): foreach($category_list as $category): ?>
                                        <dd><a href="javascript:;" data-value="<?php echo htmlentities($category['id']); ?>" data-field="category_id"><?php echo htmlentities($category['name']); ?></a></dd>
                                    <?php endforeach; else: ?>
                    ...
                    <li class="select-list">
                        <dl id="screening-price-dl">
                            ...
                            <div class="dd-conent" data-selected-tag="screening-price">
                                <dd class="select-all selected"><a href="javascript:;">不限</a></dd>
                                <?php if(!empty($screening_price_list)): foreach($screening_price_list as $screening_price): ?>
                                        <dd><a href="javascript:;" data-value="<?php echo htmlentities($screening_price['id']); ?>" data-field="screening_price_id"><?php echo htmlentities($screening_price['name']); ?></a></dd>
                                    <?php endforeach; else: ?>
            ...
            <!-- 分页 -->
            <button type="button" class="am-btn am-btn-default am-btn-block search-pages-submit" data-url="<?php echo MyUrl('index/search/goodslist'); ?>" style="display:none;">加载更多 <i class="am-icon-angle-double-down"></i></button>
        </div>
    </div>
</div>
