<?php /*a:4:{s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/express/index.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/header.html";i:1563161086;s:88:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/lib/enable.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="am-popup am-radius" id="data-save-win">
			<div class="am-popup-inner">
				...
				<div class="am-popup-bd">
					<!-- form start -->
					<form class="am-form form-validation admin-save" action="<?php echo MyUrl('admin/express/save'); ?>" method="POST" request-type="ajax-reload" request-value="">
...
<!-- 是否启用 结束 -->
        ...
        <!-- list start -->
		<div id="tree" class="m-t-15" data-additional='[{"field":"icon", "value":"", "type":"input"}, {"field":"icon_url", "value":"<?php echo htmlentities($attachment_host); ?>/static/admin/default/images/default-images.jpg", "type":"attr", "tag":"ul.express-icon-images-view li img", "style":"src"}]'>
...
<!-- footer end -->
<script>
	Tree(0, "<?php echo MyUrl('admin/express/getnodeson'); ?>", 0);
</script>