<?php /*a:3:{s:98:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/power/role_save_info.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/header.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/power/rolesave'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/power/role'); ?>">
        	<legend>
				<span class="fs-16">
				...
				<a href="<?php echo MyUrl('admin/power/role'); ?>" class="fr fs-14 m-t-5 am-icon-mail-reply"> 返回</a>
			</legend>
        	<div class="am-form-group">
				<label>角色名称</label>
				<input type="text" placeholder="角色名称" name="name" minlength="2" maxlength="16" data-validation-message="角色名称格式 2~8 个字符之间" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['name']); ?>"<?php endif; ?> required />
			</div>
			...
			<div class="am-form-group">
				...
				<ul class="tree-list p-0">
					<?php foreach($power as $v): ?>
						<li <?php if($v['is_show'] == 0): ?>class="bk-cr-ffd"<?php endif; ?>>
							<?php if(!empty($v['item'])): ?>
							...
							<?php endif; ?>
								<input type="checkbox" name="power_id" value="<?php echo htmlentities($v['id']); ?>" class="node-choice" <?php if($v['is_power'] == 'ok'): ?>checked<?php endif; ?> />
						...
						<?php if(!empty($v['item'])): ?>
							<ul class="list-find p-0 m-t-5">
								<?php foreach($v['item'] as $vs): ?>
									<li <?php if($vs['is_show'] == 0): ?>class="bk-cr-ffd"<?php endif; ?>>
										<label class="c-p">
											<input type="checkbox" name="power_id" value="<?php echo htmlentities($vs['id']); ?>" <?php if($vs['is_power'] == 'ok'): ?>checked<?php endif; ?> />
