<?php /*a:4:{s:83:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/attachment.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:76:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/nav.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'attachment']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_max_limit_image']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_max_limit_image']['describe']); ?></span></label>
                <input type="number" name="<?php echo htmlentities($data['home_max_limit_image']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_max_limit_image']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_max_limit_image']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_max_limit_image']['value']); ?>"<?php endif; ?> required />
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_max_limit_file']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_max_limit_file']['describe']); ?></span></label>
                <input type="number" name="<?php echo htmlentities($data['home_max_limit_file']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_max_limit_file']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_max_limit_file']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_max_limit_file']['value']); ?>"<?php endif; ?> required />
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_max_limit_video']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_max_limit_video']['describe']); ?></span></label>
                <input type="number" name="<?php echo htmlentities($data['home_max_limit_video']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_max_limit_video']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_max_limit_video']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_max_limit_video']['value']); ?>"<?php endif; ?> required />
            </div>
