...
<div class="am-g my-content tips-error">
    <div class="am-u-md-6 am-u-sm-centered am-text-center">
        ...
        <div class="tips-nav">
            <a href="<?php echo htmlentities(__MY_URL__); ?>" class="am-btn am-btn-secondary am-radius">回到首页</a>
            <?php if(!empty($to_url) and !empty($to_title)): ?>
                <a href="<?php echo htmlentities($to_url); ?>" class="am-btn am-btn-primary am-radius"><?php echo htmlentities($to_title); ?></a>
            <?php endif; ?>
        </div>
    </div>
</div>
