<?php /*a:4:{s:79:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/search.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:76:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/nav.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'search']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_keywords_type']['name']); ?></label>
                <select name="<?php echo htmlentities($data['home_search_keywords_type']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['home_search_keywords_type']['error_tips']); ?>">
                    <?php foreach($common_search_keywords_type_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_search_keywords_type']['value']) and $data['home_search_keywords_type']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_search_keywords']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_search_keywords']['describe']); ?></span></label>
                <input type="text" name="<?php echo htmlentities($data['home_search_keywords']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_search_keywords']['describe']); ?>" data-validation-message="<?php echo htmlentities($data['home_search_keywords']['error_tips']); ?>" class="am-radius" data-am-tagsinput <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_search_keywords']['value']); ?>"<?php endif; ?> />
            </div>
