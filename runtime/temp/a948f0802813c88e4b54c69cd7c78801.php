<?php /*a:3:{s:93:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/appconfig/index.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/header.html";i:1563161086;s:91:"/www/wwwroot/s.justwaityou1314.com/shopxo/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/appconfig/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/appconfig/index'); ?>">
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_app_is_enable_search']['name']); ?></label>
				<select name="<?php echo htmlentities($data['common_app_is_enable_search']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['common_app_is_enable_search']['error_tips']); ?>" required>
					<?php foreach($common_is_text_list as $v): ?>
						<option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_enable_search']['value']) and $data['common_app_is_enable_search']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_app_is_enable_answer']['name']); ?></label>
				<select name="<?php echo htmlentities($data['common_app_is_enable_answer']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['common_app_is_enable_answer']['error_tips']); ?>" required>
					<?php foreach($common_is_text_list as $v): ?>
						<option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_app_is_enable_answer']['value']) and $data['common_app_is_enable_answer']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_app_customer_service_tel']['name']); ?></label>
				<input type="text" name="<?php echo htmlentities($data['common_app_customer_service_tel']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['common_app_customer_service_tel']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_app_customer_service_tel']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['common_app_customer_service_tel']['value']); ?>"<?php endif; ?> />
			</div>

			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_shop_notice']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_shop_notice']['describe']); ?></span></label>
				<textarea rows="3" name="<?php echo htmlentities($data['common_shop_notice']['only_tag']); ?>" class="am-radius" placeholder="<?php echo htmlentities($data['common_shop_notice']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_shop_notice']['error_tips']); ?>"><?php if(!empty($data)): ?><?php echo htmlentities($data['common_shop_notice']['value']); ?><?php endif; ?></textarea>
			</div>
			<div class="am-form-group">
				<label><?php echo htmlentities($data['common_user_center_notice']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_user_center_notice']['describe']); ?></span></label>
				<textarea rows="3" name="<?php echo htmlentities($data['common_user_center_notice']['only_tag']); ?>" class="am-radius" placeholder="<?php echo htmlentities($data['common_user_center_notice']['name']); ?>" data-validation-message="<?php echo htmlentities($data['common_user_center_notice']['error_tips']); ?>"><?php if(!empty($data)): ?><?php echo htmlentities($data['common_user_center_notice']['value']); ?><?php endif; ?></textarea>
			</div>
