<?php /*a:4:{s:87:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/orderaftersale.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:76:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/nav.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'orderaftersale']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_only_money_reason']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_order_aftersale_return_only_money_reason']['describe']); ?></span></label>
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['describe']); ?></span></label>
                <textarea rows="6" name="<?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['only_tag']); ?>" class="am-radius" placeholder="<?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['error_tips']); ?>"><?php if(!empty($data)): ?><?php echo htmlentities($data['home_order_aftersale_return_money_goods_reason']['value']); ?><?php endif; ?></textarea>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_order_aftersale_return_goods_address']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_order_aftersale_return_goods_address']['describe']); ?></span></label>
                <input type="text" name="<?php echo htmlentities($data['home_order_aftersale_return_goods_address']['only_tag']); ?>" placeholder="<?php echo htmlentities($data['home_order_aftersale_return_goods_address']['name']); ?>" data-validation-message="<?php echo htmlentities($data['home_order_aftersale_return_goods_address']['error_tips']); ?>" class="am-radius" <?php if(!empty($data)): ?>value="<?php echo htmlentities($data['home_order_aftersale_return_goods_address']['value']); ?>"<?php endif; ?> />
            </div>
