<?php /*a:4:{s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/register.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:76:"/data/home/byu3076970001/htdocs/application/admin/view/default/site/nav.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php endif; ?>
        ...
        <!-- form start -->
        <form class="am-form form-validation view-save" action="<?php echo MyUrl('admin/site/save'); ?>" method="POST" request-type="ajax-url" request-value="<?php echo MyUrl('admin/site/index', ['nav_type'=>'register']); ?>" enctype="multipart/form-data">
            <div class="am-form-group">
                <label class="block"><?php echo htmlentities($data['home_site_user_register_bg_images']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_site_user_register_bg_images']['describe']); ?></span></label>
                <ul class="plug-file-upload-view home_site_user_register_bg_images-images-view" data-form-name="home_site_user_register_bg_images" data-max-number="1" data-dialog-type="images">
                    <?php if(!empty($data['home_site_user_register_bg_images']['value'])): ?>
                        <li>
                            <input type="text" name="home_site_user_register_bg_images" value="<?php echo htmlentities($data['home_site_user_register_bg_images']['value']); ?>" />
                            <img src="<?php echo htmlentities(__MY_PUBLIC_URL__); ?><?php echo htmlentities($data['home_site_user_register_bg_images']['value']); ?>" />
                            <i>×</i>
                        </li>
                    <?php endif; ?>
                </ul>
            ...
            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_user_reg_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_reg_state']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_user_reg_state']['only_tag']); ?>" multiple="multiple" class="am-radius chosen-select c-p" data-placeholder="<?php echo htmlentities($data['home_user_reg_state']['name']); ?>" >
                    <?php foreach($common_user_reg_state_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_reg_state']['value']) and in_array($v['value'], explode(',', $data['home_user_reg_state']['value']))): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_user_register_img_verify_state']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['home_user_register_img_verify_state']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['home_user_register_img_verify_state']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['home_user_register_img_verify_state']['error_tips']); ?>" required>
                    <?php foreach($site_img_verify_state_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_user_register_img_verify_state']['value']) and $data['home_user_register_img_verify_state']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['common_register_is_enable_audit']['name']); ?><span class="am-form-group-label-tips"><?php echo htmlentities($data['common_register_is_enable_audit']['describe']); ?></span></label>
                <select name="<?php echo htmlentities($data['common_register_is_enable_audit']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['common_register_is_enable_audit']['error_tips']); ?>" required>
                    <?php foreach($common_is_text_list as $v): ?>
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($data['common_register_is_enable_audit']['value']) and $data['common_register_is_enable_audit']['value'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>

            <div class="am-form-group">
                <label><?php echo htmlentities($data['home_is_enable_userregister_agreement']['name']); ?></label>
                <select name="<?php echo htmlentities($data['home_is_enable_userregister_agreement']['only_tag']); ?>" class="am-radius chosen-select c-p" data-validation-message="<?php echo htmlentities($data['home_is_enable_userregister_agreement']['error_tips']); ?>" required>
                    <?php foreach($site_img_verify_state_list as $v): ?>
                        <option value="<?php echo htmlentities($v['value']); ?>" <?php if(isset($data['home_is_enable_userregister_agreement']['value']) and $data['home_is_enable_userregister_agreement']['value'] == $v['value']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
