<?php /*a:3:{s:78:"/data/home/byu3076970001/htdocs/application/admin/view/default/user/index.html";i:1567480244;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!--								<button onclick="buy('<?php echo htmlentities($v['id']); ?>')" class="layui-btn layui-btn-xs layui-btn-danger" style="margin-bottom: 5px;">购买记录</button>-->
<!--								<br>-->
<!--								<button onclick="browse('<?php echo htmlentities($v['id']); ?>')" class="layui-btn layui-btn-xs" style="margin-bottom: 5px;">浏览记录</button>-->
<!--								<br>-->
<!--								<button onclick="collection('<?php echo htmlentities($v['id']); ?>')" class="layui-btn layui-btn-xs layui-btn-normal" >收藏记录</button>-->
								<a href="/admin.php?s=/user/buy/id/<?php echo htmlentities($v['id']); ?>">购买记录</a>
								<a href="/admin.php?s=/user/browse/id/<?php echo htmlentities($v['id']); ?>">浏览记录</a>
								<a href="/admin.php?s=/user/collection/id/<?php echo htmlentities($v['id']); ?>">收藏记录</a>
