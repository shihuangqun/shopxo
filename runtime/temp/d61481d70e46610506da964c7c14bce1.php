<?php /*a:3:{s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/article/index.html";i:1563161086;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/header.html";i:1566177930;s:81:"/data/home/byu3076970001/htdocs/application/admin/view/default/public/footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- form start -->
		<form class="am-form form-validation form-search" method="post" action="<?php echo MyUrl('admin/article/index'); ?>" request-type="form">
            <div class="thin">
                <div class="am-input-group am-input-group-sm am-fl so">
                    <input type="text" autocomplete="off" name="keywords" class="am-radius" placeholder="标题关键字" value="<?php if(!empty($params['keywords'])): ?><?php echo htmlentities($params['keywords']); ?><?php endif; ?>" />
            ...
            <table class="so-list more-where <?php if(!isset($params['is_more'])): ?>none<?php endif; ?>">
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="article_category_id" class="chosen-select" data-placeholder="文章分类...">
								...
								<?php foreach($article_category_list as $v): ?>
									<option value="<?php echo htmlentities($v['id']); ?>" <?php if(isset($params['article_category_id']) and $params['article_category_id'] == $v['id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['name']); ?></option>
								<?php endforeach; ?>
							</select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="input">
                            <span>热度：</span>
                            <input type="number" name="access_count" class="am-form-field am-input-sm am-radius" placeholder="浏览热度" value="<?php if(!empty($params['access_count'])): ?><?php echo htmlentities($params['access_count']); ?><?php endif; ?>" data-validation-message="热度有误" />
                        </td>
                    </tr>
                   	<tr>
                   		<td class="time">
                        ...
                        <td>
                            ...
                            <a href="<?php echo MyUrl('admin/article/index'); ?>" class="am-btn am-btn-warning am-radius am-btn-sm reset-submit">清除条件</a>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="am-g m-t-15">
            <a href="<?php echo MyUrl('admin/article/saveinfo'); ?>" class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus"> 新增</a>
        </div>
        <!-- operation end -->
			...
			<tbody>
				<?php if(!empty($data_list)): foreach($data_list as $v): ?>
						<tr id="data-list-<?php echo htmlentities($v['id']); ?>" <?php if($v['is_enable'] == 0): ?>class="am-active"<?php endif; ?>>
							<td  class="td-title">
								<a href="<?php echo htmlentities($v['url']); ?>" target="_blank" title="<?php echo htmlentities($v['title']); ?>" <?php if(!empty($v['title_color'])): ?> style="color:<?php echo htmlentities($v['title_color']); ?>;" <?php endif; ?> ><?php echo htmlentities($v['title']); ?></a>
							</td>
							<td class="am-hide-sm-only"><?php echo htmlentities($v['article_category_name']); ?></td>
							<td class="am-hide-sm-only"><?php echo htmlentities($v['access_count']); ?></td>
							<td>
								<a href="javascript:;" class="am-icon-btn am-icon-check submit-state <?php if($v['is_enable'] == 1): ?>am-success<?php else: ?>am-default<?php endif; ?>" data-url="<?php echo MyUrl('admin/article/StatusUpdate'); ?>" data-id="<?php echo htmlentities($v['id']); ?>" data-state="<?php echo htmlentities($v['is_enable']); ?>" data-is-update-status="1"></a>
							</td>
							<td>
								<a href="javascript:;" class="am-icon-btn am-icon-check submit-state <?php if($v['is_home_recommended'] == 1): ?>am-success<?php else: ?>am-default<?php endif; ?>" data-url="<?php echo MyUrl('admin/article/statushomerecommended'); ?>" data-id="<?php echo htmlentities($v['id']); ?>" data-state="<?php echo htmlentities($v['is_home_recommended']); ?>"></a>
							</td>
							<td>
									...
									<div class="am-popup-inner">
										...
										<div class="am-popup-bd">
											<dl class="dl-content">
												...
												<dt>文章分类</dt>
												<dd><?php echo htmlentities($v['article_category_name']); ?></dd>
							...
							<td class="view-operation">
								<a href="<?php echo MyUrl('admin/article/saveinfo', array_merge($params, ['id'=>$v['id']])); ?>">
									<button class="am-btn am-btn-secondary am-btn-xs am-radius am-icon-edit"> 编辑</button>
								</a>
								<button class="am-btn am-btn-danger am-btn-xs am-radius am-icon-trash-o submit-delete" data-url="<?php echo MyUrl('admin/article/delete'); ?>" data-id="<?php echo htmlentities($v['id']); ?>"> 删除</button>
							</td>
						</tr>
					<?php endforeach; ?>
				<?php endif; ?>
