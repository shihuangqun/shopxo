...
<!-- conntent start  -->
<div class="am-g my-content" <?php if(!empty($user_login_left_data['bg_color'])): ?>style="background-color:<?php echo htmlentities($user_login_left_data['bg_color']); ?>;"<?php endif; ?>>
    <div class="am-container user-login-container">
        <div class="am-hide-sm-only am-u-md-6 am-u-lg-8 am-vertical-align am-text-center container-left">
            <?php if(!empty($user_login_left_data['images'])): ?>
                <a href="<?php if(empty($user_login_left_data['url'])): ?>javascript:;<?php else: ?><?php echo htmlentities($user_login_left_data['url']); ?><?php endif; ?>" target="_blank">
                    <img src="<?php echo htmlentities($user_login_left_data['images']); ?>" class="am-vertical-align-middle" alt="用户登录" />
                </a>
            <?php endif; ?>
        </div>
    	<div class="am-u-sm-12 am-u-md-6 am-u-lg-4 container-right">
            <div class="forgetpwd-top">
                <?php if(in_array('sms', MyC('home_user_reg_state')) or in_array('email', MyC('home_user_reg_state'))): ?>
                    ...
                    <a href="<?php echo MyUrl('index/user/reginfo'); ?>" class="am-btn am-btn-secondary am-btn-xs am-radius">注册</a>
                <?php endif; ?>
            ...
            <div class="user-form-container">
        		<!-- form start -->
        		<form class="am-form form-validation" method="post" action="<?php echo MyUrl('index/user/login'); ?>" request-type="ajax-fun" request-value="LoginSuccessBack">
    				...
    				<div class="am-form-group am-form-group-refreshing">
    					...
    					<a href="<?php echo MyUrl('index/user/forgetpwdinfo'); ?>" class="am-fr">忘记密码？</a>
    				</div>
    			</form>
                <!-- form end -->
    		</div>
