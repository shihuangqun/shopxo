...
<!-- content start -->
<div class="customview-content <?php if(!isset($data['is_full_screen']) or $data['is_full_screen'] == 0): ?>am-container<?php endif; ?>">
