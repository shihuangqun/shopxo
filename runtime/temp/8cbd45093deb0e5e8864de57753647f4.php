<?php /*a:3:{s:94:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/appminiweixinlist\index.html";i:1563161086;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\header.html";i:1563161086;s:84:"C:/phpStudy/PHPTutorial/WWW/shopxo/application/admin/view/default/public\footer.html";i:1563161086;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="content-right">
	<div class="content">
		<!-- operation start -->
        <div class="am-g">
            <button class="am-btn am-btn-secondary am-radius am-btn-xs am-icon-plus submit-ajax" data-url="<?php echo MyUrl('admin/appminiweixinlist/created'); ?>" data-view="reload" data-msg="生成时间比较长，请不要关闭浏览器窗口！"> 生成</button>
        </div>
        <!-- operation end -->

		<!-- miniapp develop tips -->
        <?php if(config('shopxo.is_develop') == true): ?>
				...
				<?php if(!empty($data_list)): foreach($data_list as $v): ?>
						<tr>
							...
							<td class="view-operation">
								...
								<?php endif; ?>
								<button class="am-btn am-btn-danger am-btn-xs am-radius am-icon-trash-o submit-delete" data-url="<?php echo MyUrl('admin/appminiweixinlist/delete'); ?>" data-id="<?php echo htmlentities($v['name']); ?>" data-view="reload"> 删除</button>
							</td>
						</tr>
					<?php endforeach; ?>
				<?php endif; ?>
